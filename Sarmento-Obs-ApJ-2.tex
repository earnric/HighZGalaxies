...
\caption{The probability, per mass bin, of finding a galaxy with a metallicity in the range $1 > Z \ge 9\times 10^{-6} Z_{\odot}$ where we have binned all Pop III galaxies immediately below $Z_{\rm crit} = 10^{-5} Z_{\odot}$. Purely Pop III galaxies with $M_{\rm G} > 10^{6} M_{\odot}$ are exceedingly rare within our simulation volume ($\approx$ 4800 Mpc$^3$, comoving) occuring only at $z=10$ and 11.}
\label{fig:gMZ}
\end{center}
\end{figure*}
