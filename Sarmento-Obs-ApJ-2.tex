...
%%%%%%%%%%%%%%
\begin{abstract}
We make use of a large scale cosmological simulation in conjunction with a new subgrid model of turbulent mixing to follow the cosmological evolution of the first galaxies and, in particular, their fraction of Pop III stars. Our model enables us to track the fraction of Population III stars with $Z < Z_{\rm crit}$ created in otherwise polluted regions with an average metallicity above $Z_{\rm crit}$. We use this data to model the flux from these early galaxies and present theoretical predictions for deep galaxy surveys while also analyzing many of their characteristics that will help guide the search for Pop III stars at high redshift. In particular, we find the typical stellar mass of wholly Pop III  proto-galaxies is $M_{\rm G} \le 10^{7} M_{\odot}$ that occurs at $z=10.0$. We also generate high-redshift luminosity functions  for our galaxies and find that them in reasonable agreement with both the limited observations and the latest predictions. To aid the search for Pop III stars, we identify Pop III-bright galaxies, with at least 75\% of their flux coming from young, hot stars, and characterize them statistically. We find that 40\% of galaxies brighter than 31st magnitude will be Pop III-bright over the redshift range $13 \le z \le 16$, a magnitude range that should be within reach of the James Webb Space Telescope and other, future, missions. To that end, we also generate the LFs for a set of JWST NIRCam filters reasonable agreement with predictions of the faint-end slope out to $z=16$. 
\end{abstract}
