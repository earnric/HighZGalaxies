...
\begin{abstract}
% Keep focused on 2 main points: galaxies detectable by JWST and Pop III-bright galaxies.
...
\end{abstract}
%We use a large scale cosmological simulation, augmented with a new subgrid model of turbulent mixing, to follow the cosmological evolution of the first galaxies and to model their fraction of Population III (Pop III) stars. Our turbulence model enables us to track the fraction of Pop III stars with $Z < Z_{\rm crit}$ created in otherwise polluted regions of gas with $\overline{Z} \ge Z_{\rm crit}$. We model the flux from these early galaxies using \textit{STARBURST 99},  supplemented with a model for Pop III stellar flux, and present theoretical predictions for deep surveys while also analyzing galaxy characteristics that will help guide the search for Pop III stars at high redshift. In particular, we find the typical stellar mass of wholly Pop III proto-galaxies, which peak at $z=10$, is $M_{\rm G} < 10^{7} M_{\odot}$. We model our galaxies' luminosities and find their ultraviolet luminosity functions in reasonable agreement with both the limited observations at $z > 8$ as well as the latest extrapolations of the Schechter faint-end slope -- where our simulation samples the galaxy distribution. To aid the search for Pop III stars, we also identify Pop III-bright galaxies, with at least 75\% of their flux coming from young, hot stars, and characterize them statistically. We find that 40\% of galaxies brighter than 31 mag will be Pop III-bright over the redshift range $13 \le z \le 16$; a magnitude range that should be within reach of the James Webb Space Telescope. Finally, we predict galaxy counts for deep surveys via LFs generated using a set of JWST NIRCam filters. We find detections at $M_{AB} < -16$ for high-redshift galaxies out to $z=15$ for filters centered on 2.77 $\mu$m and redder.
...
% Then go into this... 
% Make ready care about my result... 
...
%1.58e+04,   3.40e+04,   
%7.32e+04,   1.58e+05,   3.40e+05,   7.32e+05,   1.58e+06,   3.40e+06,   7.32e+06,   1.58e+07,   3.40e+07,   
\begin{deluxetable*}{r|ccccccc} [h!tp] 
...
%%%%%%%%%%%%%%
\section{Conclusions}
% Need to summarize our main results!! Identify what is novel... 
...
\textit{We show that the contribution of Pop III stars is important at $z \ge 14$ and that getting the Pop III fraction correct is important to modeling the flux from these early galaxies.}
